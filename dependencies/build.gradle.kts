...
dependencies {
    ...
    kotlinComposeWasmDependency("org.jetbrains.compose.animation:animation:1.6.10")
    kotlinComposeWasmDependency("org.jetbrains.compose.animation:animation-graphics:1.6.10")
